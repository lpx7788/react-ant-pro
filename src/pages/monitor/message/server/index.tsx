...
interface ServerProps extends ConnectProps {
  loading: boolean;
  menuList:any;
}
...
interface ServerState {
  parameter:  any
  serverTitlecolumns:Array<Object>,
}
      ...
      <PageHeaderWrapper>
        <div className={styles.serverPage}>
          ...
          <div className={`mT20 border ${styles.pageContent}`}>
            <Table<any>  locale={{filterConfirm: '确定',filterReset: '重置'}} columns={this.state.serverTitlecolumns} size="middle"  rowKey={record => record.id} dataSource={this.props.menuList.returnObject} pagination={false} />
          </div>
          <div className="mB10" >
