...
import { Select, Input, Button, Row, Col, message, Table, Tag, Popconfirm, Tooltip } from 'antd';
const { Option } = Select;
...
interface ApplicationProps extends ConnectProps {
    loading: boolean;
    applicationList: any;
    ...
    state: ApplicationState = {
        ...
        menuTitlecolumns: [
                ...
                render: (row:any) => {
                    return(
                        <Tooltip title={row.clientSecret}>
                            <p className="ellipsis">{row.clientSecret}</p>
                        </Tooltip> 
                    )
                }
            },
            {
                ...
                render: (row:any) => {
                    return(
                        <Tooltip title={row.webServerRedirectUri}>
                            <p className="ellipsis">{row.webServerRedirectUri}</p>
                        </Tooltip> 
                    )
                }
            },
            ...
            <PageHeaderWrapper>
                <div className={styles.ApplicationPage}>
                    ...
                    <div className={`mT20 border ${styles.pageContent}`}>
                        <Table<any> size="middle" scroll={{x: '100%'}} columns={this.state.menuTitlecolumns} rowKey={record => record.id} dataSource={this.props.applicationList.returnObject} pagination={false} />
                        <div className="mB10" >
