    ...
    return (
      <div className={styles.menuAdd}>
        <Drawer
          ...
          <FormItemEdit openType={this.props.openType} dispatch={this.props.dispatch}
          key={(this.props.roleInfoData.roleId || '0') + Date.now()} roleFormInfoData={this.props.roleInfoData}
          menuTreeData={this.props.menuTreeData} handleClose={this.onClose} />
        </Drawer>
      </div>
    );
  }
