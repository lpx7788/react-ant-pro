      ...
      },
      {
        ...
        render: (row: any) =>
          <div className="handle_btn">
            ...
            <Authorized
              authority={['admin']} >
              <HandleButton icon="deployment-unit" title="权限分配" handleClick={this.handleNewBtn.bind(this, 'permission', row)}/>
      ...
      <PageHeaderWrapper>
        <div className={styles.roleManagementPage}>
          ...
          <div className={`mT20 border ${styles.pageContent}`}>
            <Table<any> size="middle"  columns={this.state.roleTitlecolumns} rowKey={record => record.id} dataSource={this.props.roleList.data} pagination={false} />
            <div className="mB10" >
